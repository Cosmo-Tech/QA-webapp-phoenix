...
export const URL_ROOT = 'https://staging.api.cosmotech.com';
...
export const ROLES_PERMISSIONS_MAP = {
  [ROLES.SCENARIO.VIEWER]: {
    ...
    notGranted: [PERMISSIONS.SCENARIO.LAUNCH, PERMISSIONS.SCENARIO.WRITE, PERMISSIONS.SCENARIO.VALIDATE, PERMISSIONS.SCENARIO.WRITE_SECURITY, PERMISSIONS.SCENARIO.DELETE],
  },
  [ROLES.SCENARIO.EDITOR]: {
    granted: [PERMISSIONS.SCENARIO.READ, PERMISSIONS.SCENARIO.READ_SECURITY, PERMISSIONS.SCENARIO.LAUNCH, PERMISSIONS.SCENARIO.WRITE],
  ...
  [ROLES.SCENARIO.VALIDATOR]: {
    granted: [PERMISSIONS.SCENARIO.READ, PERMISSIONS.SCENARIO.READ_SECURITY, PERMISSIONS.SCENARIO.LAUNCH, PERMISSIONS.SCENARIO.WRITE, PERMISSIONS.SCENARIO.VALIDATE],
    notGranted: [PERMISSIONS.SCENARIO.WRITE_SECURITY, PERMISSIONS.SCENARIO.DELETE],
  },
  [ROLES.SCENARIO.ADMIN]: {
    granted: [PERMISSIONS.SCENARIO.READ, PERMISSIONS.SCENARIO.READ_SECURITY, PERMISSIONS.SCENARIO.LAUNCH, PERMISSIONS.SCENARIO.WRITE, PERMISSIONS.SCENARIO.VALIDATE, PERMISSIONS.SCENARIO.WRITE_SECURITY, PERMISSIONS.SCENARIO.DELETE],
    notGranted: [],
  },
};
